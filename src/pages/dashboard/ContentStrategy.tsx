...
import { FileText, Calendar as CalendarIcon, BarChart3, Lightbulb, CheckCircle } from "lucide-react";
...
const ContentStrategy = () => {
  ...
  const handleGenerateStrategy = () => {
    toast({
      ...
      description: "Your 30-day content strategy has been created.",
    });
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <Button className="w-full bg-brand-purple hover:bg-brand-dark-purple" onClick={handleGenerateStrategy}>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>AI features powering your strategy</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="text-sm font-medium">Strategy Alignment</h3>
                  <p className="text-xs text-muted-foreground">Brand archetype + audience + funnel stage</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="h-8 w-8 rounded-full bg-brand-purple/20 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h3 className="text-sm font-medium">Adaptive Themes</h3>
                  <p className="text-xs text-muted-foreground">Weekly focus areas automatically scheduled</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="h-8 w-8 rounded-full bg-brand-purple/20 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">AI-generated multimodal content ideas</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-5 gap-3 mt-4">
                  {Array.from({ length: 20 }).map((_, index) => (
                    <div key={index} className="aspect-square border rounded-md p-2 text-xs flex flex-col">
                            ...
                            <div key={index} className="flex items-start">
                              ...
                              <div>
                                ...
                                <div className="flex space-x-2 mt-1">
                                  <Button variant="outline" size="sm" className="h-6 text-xs">Use</Button>
                                  <Button variant="ghost" size="sm" className="h-6 text-xs">Regenerate</Button>
                                </div>
                              </div>
                            </div>
                          ))}
