...
const Newsletter = () => {
  ...
  return <section id="newsletter" className="py-16 bg-gradient-to-b from-background bg-purple-80">
      <div className="container max-w-6xl mx-auto px-4">
        <div className="bg-card/40 backdrop-blur-md shadow-lg rounded-2xl p-8 md:p-12 border border-white/10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4 text-purple-800 md:text-5xl">Stay Updated</h2>
