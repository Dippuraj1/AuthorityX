...
const HeroSection = () => {
  ...
  return (
    <section className="relative py-20 pb-40 px-4 sm:px-6 lg:px-8 overflow-hidden bg-blue-600 text-white">
      {/* Decorative elements */}
        ...
        <div className="animate-fade-in space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-white text-white hover:bg-white/10 px-8 py-6 text-lg font-semibold backdrop-blur-sm"
            >
              Watch Demo
            </Button>
          </div>
